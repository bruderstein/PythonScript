...
def writeCppFile(f,out):
	...
	out.write('\t\tif (m_bufferPtr && m_bufferLen > 0) m_bufferPtr[m_bufferLen-1] = \'\\0\';\n')
	out.write('\t}\n')
	out.write('\tinline explicit PythonCompatibleStrBuffer(LRESULT length) :\n')
	out.write('\t\tm_bufferLen(length >= 0 ? (size_t)(length+1) : 0),\n')
	out.write('\t\tm_bufferPtr(new char[m_bufferLen])\n')
	out.write('\t{\n')
	out.write('\t\tif (m_bufferPtr && m_bufferLen > 0) m_bufferPtr[m_bufferLen-1] = \'\\0\';\n')
	...
	out.write('private:\n')
	out.write('\tPythonCompatibleStrBuffer() = delete;  // default constructor disabled\n')
	out.write('\tPythonCompatibleStrBuffer(const PythonCompatibleStrBuffer&) = delete; // copy constructor disabled\n')
	out.write('\tPythonCompatibleStrBuffer& operator = (const PythonCompatibleStrBuffer&) = delete; // Disable assignment operator disabled\n')
