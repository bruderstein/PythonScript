...
void export_notepad()
{
	...
	boost::python::class_<NotepadPlusWrapper, boost::shared_ptr<NotepadPlusWrapper>, boost::noncopyable>("Notepad", boost::python::no_init)
		...
		.def("getToolBarIconSetChoice", &NotepadPlusWrapper::getToolBarIconSetChoice, "Get Notepad++ toolbar icon set choice (Fluent UI: small, Fluent UI: large, Filled Fluent UI: small, Filled Fluent UI: large and Standard icons: small.")
	...
	boost::python::enum_<BufferEncoding>("BUFFERENCODING")
		...
		.value("COOKIE", uniUTF8_NoBOM)
		.value("UTF8_NOBOM", uniUTF8_NoBOM)
		.value("ANSI", uni7Bit)
	...
	boost::python::enum_<Notification>("NOTIFICATION")
		...
		.value("DARKMODECHANGED", NPPNOTIF_DARKMODECHANGED)
		.value("CMDLINEPLUGINMSG", NPPNOTIF_CMDLINEPLUGINMSG)
		.value("EXTERNALLEXERBUFFER", NPPNOTIF_EXTERNALLEXERBUFFER)
		.value("GLOBALMODIFIED", NPPNOTIF_GLOBALMODIFIED)
		.value("NATIVELANGCHANGED", NPPNOTIF_NATIVELANGCHANGED);
	...
	boost::python::enum_<MenuCommands>("MENUCOMMAND")
		...
		.value("FILE_OPENFOLDERASWORKSPACE", NPPIDM_FILE_OPENFOLDERASWORKSPACE)
		...
		.value("FILE_CLOSEALL_BUT_PINNED", NPPIDM_FILE_CLOSEALL_BUT_PINNED)
		.value("FILE_OPEN_POWERSHELL", NPPIDM_FILE_OPEN_POWERSHELL)
		...
		.value("EDIT_TOGGLEREADONLY", NPPIDM_EDIT_TOGGLEREADONLY)
		...
		.value("EDIT_TOGGLESYSTEMREADONLY", NPPIDM_EDIT_TOGGLESYSTEMREADONLY)
		...
		.value("EDIT_OPENSELECTEDFILETOEDIT", NPPIDM_EDIT_OPENSELECTEDFILETOEDIT)
		.value("EDIT_OPENSELECTEDFILEFOLDERINEXPLORER", NPPIDM_EDIT_OPENSELECTEDFILEFOLDERINEXPLORER)
		...
		.value("EDIT_BEGINENDSELECT_COLUMNMODE", NPPIDM_EDIT_BEGINENDSELECT_COLUMNMODE)
		.value("EDIT_MULTISELECTALL", NPPIDM_EDIT_MULTISELECTALL)
		.value("EDIT_MULTISELECTALLMATCHCASE", NPPIDM_EDIT_MULTISELECTALLMATCHCASE)
		.value("EDIT_MULTISELECTALLWHOLEWORD", NPPIDM_EDIT_MULTISELECTALLWHOLEWORD)
		.value("EDIT_MULTISELECTALLMATCHCASEWHOLEWORD", NPPIDM_EDIT_MULTISELECTALLMATCHCASEWHOLEWORD)
		.value("EDIT_MULTISELECTNEXT", NPPIDM_EDIT_MULTISELECTNEXT)
		.value("EDIT_MULTISELECTNEXTMATCHCASE", NPPIDM_EDIT_MULTISELECTNEXTMATCHCASE)
		.value("EDIT_MULTISELECTNEXTWHOLEWORD", NPPIDM_EDIT_MULTISELECTNEXTWHOLEWORD)
		.value("EDIT_MULTISELECTNEXTMATCHCASEWHOLEWORD", NPPIDM_EDIT_MULTISELECTNEXTMATCHCASEWHOLEWORD)
		.value("EDIT_MULTISELECTUNDO", NPPIDM_EDIT_MULTISELECTUNDO)
		.value("EDIT_MULTISELECTSSKIP", NPPIDM_EDIT_MULTISELECTSSKIP)
		.value("EDIT_SORTLINES_LOCALE_ASCENDING", NPPIDM_EDIT_SORTLINES_LOCALE_ASCENDING)
		.value("EDIT_SORTLINES_LOCALE_DESCENDING", NPPIDM_EDIT_SORTLINES_LOCALE_DESCENDING)
		.value("EDIT_SETREADONLYFORALLDOCS", NPPIDM_EDIT_SETREADONLYFORALLDOCS)
		.value("EDIT_CLEARREADONLYFORALLDOCS", NPPIDM_EDIT_CLEARREADONLYFORALLDOCS)
		.value("EDIT_SORTLINES_LENGTH_ASCENDING", NPPIDM_EDIT_SORTLINES_LENGTH_ASCENDING)
		.value("EDIT_SORTLINES_LENGTH_DESCENDING", NPPIDM_EDIT_SORTLINES_LENGTH_DESCENDING)
		.value("EDIT_REDACT_SELECTION", NPPIDM_EDIT_REDACT_SELECTION)
		...
		.value("SEARCH_CHANGED_NEXT", NPPIDM_SEARCH_CHANGED_NEXT)
		.value("SEARCH_CHANGED_PREV", NPPIDM_SEARCH_CHANGED_PREV)
		.value("SEARCH_CLEAR_CHANGE_HISTORY", NPPIDM_SEARCH_CLEAR_CHANGE_HISTORY)
		...
		.value("VIEW_ZOOM_SYNC", NPPIDM_VIEW_ZOOM_SYNC)
		...
		.value("VIEW_TAB_START", NPPIDM_VIEW_TAB_START)
		.value("VIEW_TAB_END", NPPIDM_VIEW_TAB_END)
		.value("VIEW_NPC", NPPIDM_VIEW_NPC)
		.value("VIEW_NPC_CCUNIEOL", NPPIDM_VIEW_NPC_CCUNIEOL)
		...
		.value("VIEW_GOTO_START", NPPIDM_VIEW_GOTO_START)
		.value("VIEW_GOTO_END", NPPIDM_VIEW_GOTO_END)
		...
		.value("LANG_JSON5", NPPIDM_LANG_JSON5)
		.value("LANG_MSSQL", NPPIDM_LANG_MSSQL)
		.value("LANG_GDSCRIPT", NPPIDM_LANG_GDSCRIPT)
		.value("LANG_HOLLYWOOD", NPPIDM_LANG_HOLLYWOOD)
		.value("LANG_GOLANG", NPPIDM_LANG_GOLANG)
		.value("LANG_RAKU", NPPIDM_LANG_RAKU)
		.value("LANG_TOML", NPPIDM_LANG_TOML)
		.value("LANG_SAS", NPPIDM_LANG_SAS)
		.value("LANG_ERRORLIST", NPPIDM_LANG_ERRORLIST)
		.value("LANG_ESCSEQ", NPPIDM_LANG_ESCSEQ)
		...
		.value("SETTING_IMPORTSTYLETHEMES", NPPIDM_SETTING_IMPORTSTYLETHEMES)
		...
		.value("TOOL_SHA1_GENERATE", NPPIDM_TOOL_SHA1_GENERATE)
		.value("TOOL_SHA1_GENERATEFROMFILE", NPPIDM_TOOL_SHA1_GENERATEFROMFILE)
		.value("TOOL_SHA1_GENERATEINTOCLIPBOARD", NPPIDM_TOOL_SHA1_GENERATEINTOCLIPBOARD)
		.value("TOOL_SHA512_GENERATE", NPPIDM_TOOL_SHA512_GENERATE)
		.value("TOOL_SHA512_GENERATEFROMFILE", NPPIDM_TOOL_SHA512_GENERATEFROMFILE)
		.value("TOOL_SHA512_GENERATEINTOCLIPBOARD", NPPIDM_TOOL_SHA512_GENERATEINTOCLIPBOARD)

		.value("EXECUTE", NPPIDM_EXECUTE)
		.value("EXECUTE_VALIDATE_SHORTCUTSXML", NPPIDM_EXECUTE_VALIDATE_SHORTCUTSXML)
