...
BOOST_PYTHON_MODULE(Npp)
{
	...
	boost::python::class_<ScintillaWrapper>("Editor", boost::python::no_init)
		...
		.def("deleteRange", &ScintillaWrapper::DeleteRange, "Delete a range of text in the document.")
		...
		.def("markerSetBackSelected", &ScintillaWrapper::MarkerSetBackSelected, "Set the background colour used for a particular marker number when its folding block is selected.")
		.def("markerEnableHighlight", &ScintillaWrapper::MarkerEnableHighlight, "Enable/disable highlight for current folding bloc (smallest one that contains the caret)")
		...
		.def("styleSetSizeFractional", &ScintillaWrapper::StyleSetSizeFractional, "Set the size of characters of a style. Size is in points multiplied by 100.")
		.def("styleGetSizeFractional", &ScintillaWrapper::StyleGetSizeFractional, "Get the size of characters of a style in points multiplied by 100")
		.def("styleSetWeight", &ScintillaWrapper::StyleSetWeight, "Set the weight of characters of a style.")
		.def("styleGetWeight", &ScintillaWrapper::StyleGetWeight, "Get the weight of characters of a style.")
		...
		.def("countCharacters", &ScintillaWrapper::CountCharacters, "Count characters between two positions.")
		...
		.def("setEmptySelection", &ScintillaWrapper::SetEmptySelection, "Set caret to a position, while removing any existing selection.")
		...
		.def("scrollRange", &ScintillaWrapper::ScrollRange, "Scroll the argument positions and the range between them into view giving\npriority to the primary position then the secondary position.\nThis may be used to make a search match visible.")
		...
		.def("callTipSetPosStart", &ScintillaWrapper::CallTipSetPosStart, "Set the start position in order to change when backspacing removes the calltip.")
		...
		.def("callTipSetPosition", &ScintillaWrapper::CallTipSetPosition, "Set position of calltip, above or below text.")
		...
		.def("foldLine", &ScintillaWrapper::FoldLine, "Expand or contract a fold header.")
		.def("foldChildren", &ScintillaWrapper::FoldChildren, "Expand or contract a fold header and its children.")
		.def("expandChildren", &ScintillaWrapper::ExpandChildren, "Expand a fold header and all children. Use the level argument instead of the line's current level.")
		.def("foldAll", &ScintillaWrapper::FoldAll, "Expand or contract all fold headers.")
		...
		.def("setAutomaticFold", &ScintillaWrapper::SetAutomaticFold, "Set automatic folding behaviours.")
		...
		.def("braceHighlightIndicator", &ScintillaWrapper::BraceHighlightIndicator, "Use specified indicator to highlight matching braces instead of changing their style.")
		...
		.def("braceBadLightIndicator", &ScintillaWrapper::BraceBadLightIndicator, "Use specified indicator to highlight non matching brace instead of changing its style.")
		...
		.def("setXOffset", &ScintillaWrapper::SetXOffset, "Get and Set the xOffset (ie, horizontal scroll position).")
		...
		.def("setXCaretPolicy", &ScintillaWrapper::SetXCaretPolicy, "Set the way the caret is kept visible when going sideways.\nThe exclusion zone is given in pixels.")
		...
		.def("positionRelative", &ScintillaWrapper::PositionRelative, "Given a valid document position, return a position that differs in a number\nof characters. Returned value is always between 0 and last position in document.")
		...
		.def("setPunctuationChars", &ScintillaWrapper::SetPunctuationChars, "Set the set of characters making up punctuation characters\nShould be called after SetWordChars.")
		...
		.def("autoCSetCaseInsensitiveBehaviour", &ScintillaWrapper::AutoCSetCaseInsensitiveBehaviour, "Set auto-completion case insensitive behaviour to either prefer case-sensitive matches or have no preference.")
		...
		.def("autoCSetOrder", &ScintillaWrapper::AutoCSetOrder, "Set the way autocompletion lists are ordered.")
		...
		.def("indicSetOutlineAlpha", &ScintillaWrapper::IndicSetOutlineAlpha, "Set the alpha outline colour of the given indicator.")
		.def("indicGetOutlineAlpha", &ScintillaWrapper::IndicGetOutlineAlpha, "Get the alpha outline colour of the given indicator.")
		...
		.def("setMarginOptions", &ScintillaWrapper::SetMarginOptions, "Set the margin options.")
		...
		.def("allocateExtendedStyles", &ScintillaWrapper::AllocateExtendedStyles, "Allocate some extended (>255) style numbers and return the start of the range")
		...
		.def("setMouseSelectionRectangularSwitch", &ScintillaWrapper::SetMouseSelectionRectangularSwitch, "Set whether switching to rectangular mode while selecting with the mouse is allowed.")
		...
		.def("dropSelectionN", &ScintillaWrapper::DropSelectionN, "Drop one selection")
		...
		.def("setIdentifier", &ScintillaWrapper::SetIdentifier, "Set the identifier reported as idFrom in notification messages.")
		.def("getIdentifier", &ScintillaWrapper::GetIdentifier, "Get the identifier.")
		.def("rGBAImageSetWidth", &ScintillaWrapper::RGBAImageSetWidth, "Set the width for future RGBA image data.")
		.def("rGBAImageSetHeight", &ScintillaWrapper::RGBAImageSetHeight, "Set the height for future RGBA image data.")
		.def("rGBAImageSetScale", &ScintillaWrapper::RGBAImageSetScale, "Set the scale factor in percent for future RGBA image data.")
		.def("markerDefineRGBAImage", &ScintillaWrapper::MarkerDefineRGBAImage, "Define a marker from RGBA data.\nIt has the width and height from RGBAImageSetWidth/Height")
		.def("registerRGBAImage", &ScintillaWrapper::RegisterRGBAImage, "Register an RGBA image for use in autocompletion lists.\nIt has the width and height from RGBAImageSetWidth/Height")
		...
		.def("setTechnology", &ScintillaWrapper::SetTechnology, "Set the technology used.")
		.def("getTechnology", &ScintillaWrapper::GetTechnology, "Get the tech.")
		.def("createLoader", &ScintillaWrapper::CreateLoader, "Create an ILoader*.")
		.def("findIndicatorShow", &ScintillaWrapper::FindIndicatorShow, "On OS X, show a find indicator.")
		.def("findIndicatorFlash", &ScintillaWrapper::FindIndicatorFlash, "On OS X, flash a find indicator, then fade out.")
		...
		.def("setCaretLineVisibleAlways", &ScintillaWrapper::SetCaretLineVisibleAlways, "Sets the caret line to always visible.")
		.def("setRepresentation", &ScintillaWrapper::SetRepresentation, "Set the way a character is drawn.")
		.def("getRepresentation", &ScintillaWrapper::GetRepresentation, "Set the way a character is drawn.")
		.def("clearRepresentation", &ScintillaWrapper::ClearRepresentation, "Remove a character representation.")
		...
		.def("setLineEndTypesAllowed", &ScintillaWrapper::SetLineEndTypesAllowed, "Set the line end types that the application wants to use. May not be used if incompatible with lexer or encoding.")
		...
		.def("allocateSubStyles", &ScintillaWrapper::AllocateSubStyles, "Allocate a set of sub styles for a particular base style, returning start of range")
		.def("getSubStylesStart", &ScintillaWrapper::GetSubStylesStart, "The starting style number for the sub styles associated with a base style")
		.def("getSubStylesLength", &ScintillaWrapper::GetSubStylesLength, "The number of sub styles associated with a base style")
		.def("getStyleFromSubStyle", &ScintillaWrapper::GetStyleFromSubStyle, "For a sub style, return the base style, else return the argument.")
		.def("getPrimaryStyleFromStyle", &ScintillaWrapper::GetPrimaryStyleFromStyle, "For a secondary style, return the primary style, else return the argument.")
		.def("freeSubStyles", &ScintillaWrapper::FreeSubStyles, "Free allocated sub styles")
		.def("setIdentifiers", &ScintillaWrapper::SetIdentifiers, "Set the identifiers that are shown in a particular style")
