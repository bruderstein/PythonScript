...
BOOST_PYTHON_MODULE(Npp)
{
	...
	boost::python::class_<ScintillaWrapper, boost::shared_ptr<ScintillaWrapper>, boost::noncopyable >("Editor", boost::python::no_init)
		 ...
		 */ 
		/* ++Autogenerated -------------------- */
		.def("addText", &ScintillaWrapper::AddText, boost::python::args("length", "text"), "Add text to the document at current position.")
		.def("addStyledText", &ScintillaWrapper::AddStyledText, boost::python::args("length", "c"), "Add array of cells to document.")
		.def("insertText", &ScintillaWrapper::InsertText, boost::python::args("pos", "text"), "Insert string at a position.")
		.def("changeInsertion", &ScintillaWrapper::ChangeInsertion, boost::python::args("length", "text"), "Change the text that is being inserted in response to SC_MOD_INSERTCHECK")
		...
		.def("setStylingEx", &ScintillaWrapper::SetStylingEx, boost::python::args("length", "styles"), "Set the styles for a segment of the document.")
		...
		.def("replaceTarget", &ScintillaWrapper::ReplaceTarget, boost::python::args("length", "text"), "Replace the target text with the argument text.\nText is counted so it can contain NULs.\nReturns the length of the replacement text.")
		.def("replaceTargetRE", &ScintillaWrapper::ReplaceTargetRE, boost::python::args("length", "text"), "Replace the target text with the argument text after \\d processing.\nText is counted so it can contain NULs.\nLooks for \\d where d is between 1 and 9 and replaces these with the strings\nmatched in the last search operation which were surrounded by \\( and \\).\nReturns the length of the replacement text including any change\ncaused by processing the \\d patterns.")
		.def("searchInTarget", &ScintillaWrapper::SearchInTarget, boost::python::args("length", "text"), "Search for a counted string in the target and set the target to the found\nrange. Text is counted so it can contain NULs.\nReturns start of found range or -1 for failure in which case target is not moved.")
		...
		.def("appendText", &ScintillaWrapper::AppendText, boost::python::args("length", "text"), "Append a string to the end of the document without changing the selection.")
		...
		.def("copyText", &ScintillaWrapper::CopyText, boost::python::args("length", "text"), "Copy argument text to the clipboard.")
