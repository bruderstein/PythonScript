...
BOOST_PYTHON_MODULE(Npp)
{
	...
	boost::python::class_<ScintillaWrapper, boost::shared_ptr<ScintillaWrapper>, boost::noncopyable >("Editor", boost::python::no_init)
		...
		.def("setScaleTechnique", &ScintillaWrapper::SetScaleTechnique, boost::python::args("technique"), "Set the scale technique")
		.def("getScaleTechnique", &ScintillaWrapper::GetScaleTechnique, "Get the scale technique")
