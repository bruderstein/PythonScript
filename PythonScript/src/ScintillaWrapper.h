...
public:
  ...
  */
	void AddText(intptr_t length, boost::python::object text);

	/** Add array of cells to document.
  */
	void AddStyledText(intptr_t length, ScintillaCells c);
  ...
  */
	void ChangeInsertion(intptr_t length, boost::python::object text);
  ...
  */
	void SetStylingEx(intptr_t length, boost::python::object styles);
  ...
  */
	intptr_t FindText(FindOption searchFlags, int start, int end, boost::python::object ft);
  ...
  */
	intptr_t ReplaceTarget(intptr_t length, boost::python::object text);
  ...
  */
	intptr_t ReplaceTargetRE(intptr_t length, boost::python::object text);

	/** Search for a counted string in the target and set the target to the found
	  * range. Text is counted so it can contain NULs.
	  * Returns start of found range or -1 for failure in which case target is not moved.
  */
	intptr_t SearchInTarget(intptr_t length, boost::python::object text);
  ...
  */
	void SetFoldLevel(intptr_t line, FoldLevel level);

	/** Retrieve the fold level of a line.
  */
	FoldLevel GetFoldLevel(intptr_t line);

	/** Find the last child line of a header line.
  */
	intptr_t GetLastChild(intptr_t line, FoldLevel level);
  ...
  */
	void FoldLine(intptr_t line, FoldAction action);

	/** Expand or contract a fold header and its children.
  */
	void FoldChildren(intptr_t line, FoldAction action);

	/** Expand a fold header and all children. Use the level argument instead of the line's current level.
  */
	void ExpandChildren(intptr_t line, FoldLevel level);
  ...
  */
	void AppendText(intptr_t length, boost::python::object text);
  ...
  */
	intptr_t SearchNext(FindOption searchFlags, boost::python::object text);

	/** Find some text starting at the search anchor and moving backwards.
	  * Does not ensure the selection is visible.
  */
	intptr_t SearchPrev(FindOption searchFlags, boost::python::object text);
  ...
  */
	intptr_t CreateDocument(intptr_t bytes, DocumentOption documentOptions);
  ...
  */
	void CopyText(intptr_t length, boost::python::object text);
  ...
  */
	boost::python::str MarginGetText();
  ...
  */
	boost::python::str MarginGetStyles();
  ...
  */
	boost::python::str AnnotationGetText();
  ...
  */
	boost::python::str AnnotationGetStyles();
  ...
  */
	...
	/** Create an ILoader*.
  */
	intptr_t CreateLoader(intptr_t bytes, DocumentOption documentOptions);
  ...
  */
	TypeProperty PropertyType(boost::python::object name);
  ...
  */
	intptr_t LineFromIndexPosition(intptr_t pos, LineCharacterIndexType lineCharacterIndex);

	/** Retrieve the position measured in index units at the start of a document line.
  */
	intptr_t IndexPositionFromLine(intptr_t line, LineCharacterIndexType lineCharacterIndex);
