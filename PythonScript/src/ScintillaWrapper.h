...
public:
	...
	void ScintillaWrapper::pyreplaceNoFlagsNoCount(boost::python::object searchExp, boost::python::object replaceStr)
					{	pyreplace(searchExp, replaceStr, object(0), object(0)); };
	void ScintillaWrapper::pyreplaceNoFlags(boost::python::object searchExp, boost::python::object replaceStr, boost::python::object count)
	...
	void ScintillaWrapper::pymlreplaceNoFlagsNoCount(boost::python::object searchExp, boost::python::object replaceStr)
					{	pymlreplace(searchExp, replaceStr, object(0), object(0)); };
	void ScintillaWrapper::pymlreplaceNoFlags(boost::python::object searchExp, boost::python::object replaceStr, boost::python::object count)
