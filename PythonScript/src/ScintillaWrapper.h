...
public:
	...
	void ScintillaWrapper::pyreplaceNoCount(boost::python::object searchExp, boost::python::object replaceStr)
					{	pyreplace(searchExp, replaceStr, object(0)); };
	void ScintillaWrapper::pymlreplace(boost::python::object searchExp, boost::python::object replaceStr, boost::python::object count);
	void ScintillaWrapper::pymlreplaceNoCount(boost::python::object searchExp, boost::python::object replaceStr)
					{	pymlreplace(searchExp, replaceStr, object(0)); };
