...
public:
  ...
  */
	int AddText(boost::python::str text);
  ...
  */
	int SetStylingEx(boost::python::str styles);
  ...
  */
	boost::python::object FindText(int flags, int start, int end, boost::python::str ft);
  ...
  */
	int ReplaceTarget(boost::python::str text);
  ...
  */
	int ReplaceTargetRE(boost::python::str text);

	/** Search for a counted string in the target and set the target to the found
	  * range. Text is counted so it can contain NULs.
	  * Returns length of range or -1 for failure in which case target is not moved.
  */
	int SearchInTarget(boost::python::str text);
  ...
  */
	int AppendText(boost::python::str text);
  ...
  */
	int CopyText(boost::python::str text);
