...
echo Copying python310.dll
copy %PYTHONBUILDDIR%\python310.dll %INST_TEMP_DIR%\release\Full\plugins\PythonScript
copy %PYTHONBUILDDIR%\python310.dll %INST_TEMP_DIR%\release\Min\plugins\PythonScript
